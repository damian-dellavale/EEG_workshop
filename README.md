...
### [Program & Schedule](program/EEG_workshop_v3.pdf) &nbsp;&nbsp;&nbsp;&bull;&nbsp;&nbsp;&nbsp; [Workshop poster](program/EEG_Workshop_Poster.pdf)
...
|:---|:---|
|||
| Neuronal avalanches and criticality. Aperiodic and scale-free activities. Long-range temporal correlations.
  Detrended fluctuation analysis scaling exponent and spectral aperiodic exponent | Theoretical background <br> Analytic examples |
...
- [Avalanches-oscillations interaction in neurodegenerative diseases](https://doi.org/10.1162/IMAG.a.1193)
...
Contact your university's Information Technology Services (ITS) for instructions on how to use your academic email address (e.g., .edu.tr) to install the MATLAB version available through your institution's licence.
